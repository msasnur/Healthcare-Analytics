...
<div class="flex items-end pt-1 dark:bg-zinc-900 rounded-t">
    ...
    <div class="flex items-center px-4 dark:fill-white border-b border-gray-500 h-11">
        ...
        <span class="uppercase text-sm ml-2 py-2 leading-4 w-min">12&nbsp;issues detected</span>
    </div>
...
<div id="Performance" role="tabpanel" class="m-4 mb-4">
...
<p>To learn more about causes and solutions, check our <a href="https://docs.giskard.ai/en/latest/getting-started/key_vulnerabilities/performance_bias/index.html">guide on performance bias.</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center space-x-1">
        ...
        <span class="text-xs border rounded px-1 uppercase text-amber-200 border-amber-200">8
            medium</span>
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        For records in your dataset where `Hospital_code` == 26, the Precision is 12.19% lower than the global Precision.
    ...
    <tr>
      ...
      <td>2 (p = 0.35)</td>
        ...
        <p class="text-sm my-2">
            The hypothesis that the <em>Precision</em> on the data slice was different with respect
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `City_Code_Hospital` == 2, the Precision is 12.0% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Ward_Facility_Code` == &#34;D&#34;, the Precision is 12.0% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Hospital_code` == 11, the Precision is 11.34% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Ward_Facility_Code` == &#34;A&#34;, the Precision is 8.8% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `City_Code_Hospital` == 3, the Precision is 8.36% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Hospital_type_code` == &#34;b&#34;, the Precision is 7.86% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Hospital_type_code` == &#34;c&#34;, the Precision is 6.95% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Ward_Type` == &#34;S&#34;, the Precision is 6.36% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `City_Code_Patient` == 5.000, the Precision is 5.78% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Type of Admission` == &#34;Emergency&#34;, the Precision is 5.74% lower than the global Precision.
...
<tr class="gsk-issue-detail text-left hidden  peer-[.open]:table-row border-b border-zinc-500 bg-zinc-700">
    <td colspan="1000" class="p-3">
        ...
        <h4 class="font-bold text-sm">Description</h4>
        For records in your dataset where `Hospital_region_code` == &#34;Z&#34;, the Precision is 5.52% lower than the global Precision.
